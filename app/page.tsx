    ...
    <main id="top">
      ...
      <section id="practice" className="practice-section section-dark" aria-labelledby="practice-title">
        ...
        <div id="today" className="practice-context">
          <div><h3>Что такое ТОП</h3><p>ТОП — «телесно-ориентированная психология». В своих программах я соединяю телесную практику, движение, внимание и работу с группой. Этот подход вырос из опыта проекта «Жизнь без страха».</p></div>
      ...
      <section id="story" className="story-section section-light" aria-labelledby="story-title">
        ...
        <div id="sport" className="career-strip" aria-label="Телевизионные проекты, спорт и рекорды">
          ...
          <article><span>Гвоздестояние</span><strong>6 мировых рекордов</strong><small>участие в рекордах</small></article>
